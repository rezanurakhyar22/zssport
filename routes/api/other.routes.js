...
const routes = [
    ...
    },
    {
        ...
        path: '/kata2',
        handler: (h, r) => {
            return r.file(Path.join(__dirname, '../../public/files/kata2.html'))
        }
    },
    {
        method: FETCH_REQUEST_TYPES.GET,
    ...
    },
    {
        ...
        path: '/katabendera2',
        handler: (h, r) => {
            return r.file(Path.join(__dirname, '../../public/files/katabendera2.html'))
        }
    },
    {
        method: FETCH_REQUEST_TYPES.GET,
    ...
    },
    {
        ...
        handler: (h, r) => {
            ...
            } else if (h.params.name === 'kata2' || h.params.name === 'kata-2') {
                return r.file(Path.join(__dirname, '../../public/files/scoreboard-kata-2.html'))
            } else if (h.params.name === 'katabendera') {
                return r.file(Path.join(__dirname, '../../public/files/scoreboard-katabendera.html'))
            } else if (h.params.name === 'katabendera2' || h.params.name === 'katabendera-2') {
                return r.file(Path.join(__dirname, '../../public/files/scoreboard-katabendera-2.html'))
            } else {
